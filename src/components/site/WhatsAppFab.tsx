export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-foreground text-background shadow-luxe transition-all hover:scale-110 md:bottom-8 md:right-8"
    >
